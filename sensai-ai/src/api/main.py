# adityavofficial-hyperverge-hackathon-2025/sensai-ai/src/api/main.py
...
app.include_router(hub.router, prefix="/hubs", tags=["hubs"]) # Add the new hub router
